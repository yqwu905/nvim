...
map("n", "<C-l>", ":call UltiSnips#ExpandSnippet()<CR>")
map("n", "<C-k>", ":echo UltiSnips#CanExpandSnippet()<CR>")
...
local opt = require("custom.options")

opt.setup("o", "shell", "pwsh")
opt.setup("o", "tabstop", 2)
vim.cmd("set relativenumber")

-- require("custom.plugins.snippet")
