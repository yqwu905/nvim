...
vim.api.nvim_command('autocmd BufNewFile,BufRead *.marp set filetype=markdown')

vim.api.nvim_command('autocmd BufNewFile,BufRead *.md so $VIMRUNTIME/syntax/tex.vim')
